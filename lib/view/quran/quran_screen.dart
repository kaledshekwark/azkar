...
class _QuranScreenState extends State<QuranScreen> {
  ...
  void initState() {
    super.initState();
    getSurahContent();
    futureAlbum = Provider.of<AppController>(context, listen: false).fetchAlbum();
  }
